...
namespace KINZHAL
{
    ...
    {
        Ошибка_блока_оптических_фильтров = 0,
        Привод_фокусировки = 1,
        Ошибка_камеры = 2,
        Ошибка_бита_3 = 3,
        Ошибка_бита_4 = 4,
        Отсутствие_ТВ_видео =5,
        Отсутствие_ТП_видео=6,
        Неисправность_дальномера=7,
        Неисправность_МУПС=8,
        Ошибка_датчика_угла_ВН=9,
        Ошибка_датчика_угла_ГН=10,
        Авария_арретира_ВН=11,
        Авария_арретира_ГН=12,
        Неисправность_подсистемы_приводов =13,
        Ошибка_гироскопа=14,
        Ошибка_бита_15 = 15,
        Ошибка_бита_16 = 16,
        Ошибка_бита_17 = 17,
        ...
        Ошибка_бита_24 = 24,
        Ошибка_бита_25 = 25,
        Ошибка_чтения_энергонезависимой_памяти =26,
        Аварийная_остановка_ОЭС_ОП=27,
        Ошибка_информационного_обмена_подсистемы_приводов=28,
        Ошибка_информационного_обмена_ЛД=29,
        Ошибка_информационного_обмена_подсистемы_видео=30,
        Ошибка_информационного_обмена_ТП=31
    }

    public enum DIAG_CODE
    {
        Фильтр_1_не_установлен =                    (1 << 0),
        Фильтр_2_не_установлен =                    (2 << 0),
        Ошибка_привода_фокусировки =                (4 << 0),
        Ошибка_камеры =                             (5 << 0),
        Отсутствие_информационного_обмена_с_ТП =    (7 << 0),
        Отсутствие_видео_от_ТП =                    (8 << 0),
        Отсутствие_ТВ_видео=                        (0xA << 0),
        Отсутствие_ТП_видео=                        (0xB << 0),

        Ошибка_готовности_ББВ_дальномера =          (1 << 4),
        Ошибка_запуска_БВВ_дальномера =             (2 << 4),
        Включена_блокировка_ЛД =                    (3 << 4),
        Включена_блокировка_ФПУ =                   (4 << 4),
        Неисправность_дальномера =                  (5 << 4),

        Включена_защита_по_току_МУПС =              (1 << 8),
        Ошибка_АЦП_датчика_тока_МУПС =              (2 << 8),
        Ошибка_датчика_угла_ВН =                    (3 << 8),
        Ошибка_датчика_угла_ГН =                    (4 << 8),
        Авария_арретира_ВН =                        (5 << 8),
        Авария_арретира_ГН =                        (6 << 8),
        Ошибка_информационного_обмена_ПК_МУПС =     (7 << 8),
        Нет_данных_гироскопа =                      (8 << 8),
        Ошибка_управления_приводом_УМ =             (9 << 8),
        Ошибка_управления_приводом_АЗ =             (0xA << 8),
        Ошибка_наведения_по_УМ_и_или_АЗ =           (0xB << 8),

        Ошибка_чтения_энергонезависимой_памяти =    (1 << 24),
        Аварийная_остановка_ОЭС_ОП =                (2 << 24),
        Ошибка_информационного_обмена_ПК_ПУД =      (5 << 24),
        Ошибка_информационного_обмена_ПК_МУПЗС =    (6 << 24)
    }
}
